...
envTrain = gym.make("ALE/Tetris-v5", render_mode="human") # full_action_space=True render_mode="human"

q_table = np.zeros((envTrain.observation_space.high.size, envTrain.action_space.n))

alpha = 0.1 # learning rate
gamma = 0.9 # discount
epsilon = 0.3 # probability for exploration
...
for i in range(1, 500):
    observation, info = envTrain.reset(seed=42)
...
envTest = gym.make("ALE/Tetris-v5", render_mode="human")
